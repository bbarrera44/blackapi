...
RSpec.describe ParkingsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      parking = Parking.create! valid_attributes
      get :show, params: {id: parking.to_param}, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Parking" do
        expect {
          post :create, params: {parking: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the new parking" do
        ...
        post :create, params: {parking: invalid_attributes}, session: valid_session
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested parking" do
        parking = Parking.create! valid_attributes
        put :update, params: {id: parking.to_param, parking: new_attributes}, session: valid_session
        parking.reload
      ...
      it "renders a JSON response with the parking" do
        ...
        put :update, params: {id: parking.to_param, parking: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the parking" do
        ...
        put :update, params: {id: parking.to_param, parking: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested parking" do
      parking = Parking.create! valid_attributes
      expect {
        delete :destroy, params: {id: parking.to_param}, session: valid_session
      }.to change(Parking, :count).by(-1)
    end
  end
